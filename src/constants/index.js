...
export const EXPERIENCES = [
  ...
  },
  {
    ...
    description: `Developed and maintained AWS Cloud clubs official website using JavaScript, HTML, CSS. Collaborated with team members and made team projects.`,
    technologies: ["Python", "HTML", "CSS", "Javascript"],
  },
  {
    year: "2024 - 2024",
    role: "Python and Machine Learning Intern",
    company: "COE-AI IGDTUW",
    description: `I completed an 8-week internship focused on Python programming and Machine Learning, where I built and optimized ML models for data-driven projects. This experience helped me gain a deeper understanding of model development, data preprocessing, and algorithm selection.`,
    technologies: ["Python", "Pandas", "NumPy,", "SScikit-learn"],
  },
];
...
export const PROJECTS = [
  {
    ...
    image: project1,
    description:
      "An e-commerce website with features like product listing, shopping cart, and impact calculator.",
    technologies: ["HTML", "CSS", "Javascript"],
  },
  {
    title: "ML Model for prediction of cervical cancer",
    image: project4,
    description:
...
export const CONTACT = {
  address: "Air Force Camp, New Delhi ",
  phoneNo: "+91 6352292XXX ",
